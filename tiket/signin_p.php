...
if($al == 1) {
    session_start();
    $_SESSION['user']=$user;
    echo "<script>window.alert('Selamat, Anda berhasil Login!!');window.location.href='tiket/index.php';</script>";
} else {
    echo "<script>window.alert('Gagal Login!!');window.location.href='signin.php';</script>";
}
